...
function App() {
  // Page navigation: 'dashboard', 'login', 'register', 'challenges', 'scoreboard'
  ...
  if (currentPage === 'challenges') {
    return <Challenges onNavigate={setCurrentPage} currentPage={currentPage} />
  }

  if (currentPage === 'scoreboard') {
    return <Scoreboard onNavigate={setCurrentPage} currentPage={currentPage} />
  }
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0A1628] via-[#0D1B36] to-[#0A1628] relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(0,217,255,0.15)_0%,_transparent_70%)]"></div>
