...
import {
  ...
  Shield, Headphones, HardDrive, Copy,
  Check, CheckCircle2, PlusSquare, Cloud
} from 'lucide-react'
...
const WORKER = {
  ...
  cluster: 'Kovilur Health Zone • Tiruvannamalai',
    ...
    <div className="pf-root animate-fade-in">
      ...
      <div className="pf-storage-card">
        ...
        <div className="pf-storage-bottom">
          ...
          >
            {cacheCleared ? 'Cache Cleared ✓' : 'Safe to clear cache'}
          </button>
        </div>
      </div>
      ...
      <footer className="pf-footer">
        <p className="pf-footer-brand">Rural Care Navigator • v2.4 (NHM Certified)</p>
