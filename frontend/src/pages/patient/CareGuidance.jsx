...
export default function CareGuidance({ onNavigate }) {
  ...
  const reportedSymptoms = ['Fever', 'Cough', 'Headache']
  ...
  return (
    <div className="care-guidance-screen-wrapper">
      ...
      <main className="care-guidance-scrollable-content">
        {/* Top Urgency Question & Needs Attention Card */}
        <section className="urgency-question-section">
          <h2 className="urgency-question-heading">How soon should you get care?</h2>
          <div className="needs-attention-card">
            <div className="attention-badge-title">
              <span>NEEDS</span>
              <span>ATTENTION</span>
            </div>
            <p className="attention-card-desc">Please visit a doctor soon.</p>
          </div>
        </section>

        {/* Guidance Header Section */}
        <section className="care-guidance-intro">
          <h1 className="guidance-main-title">Your Care Guidance</h1>
          <p className="guidance-subtitle">Based on the symptoms you reported today.</p>
        </section>
        ...
        <section className="reported-symptoms-card">
          <div className="reported-symptoms-header">
            ...
            <h2 className="reported-symptoms-title">Reported Symptoms</h2>
          </div>
          <div className="reported-symptoms-chips">
            {reportedSymptoms.map((symptom) => (
              <span key={symptom} className="guidance-symptom-chip">
                {symptom}
              </span>
            ))}
          </div>
        ...
        <section className="guidance-detail-section">
          <h2 className="guidance-detail-heading">Why this guidance?</h2>
        ...
        {/* Where should you go? */}
        <section className="guidance-detail-section">
          <h2 className="guidance-detail-heading">Where should you go?</h2>
          <p className="guidance-detail-text">
            Start with a Primary Health Centre (PHC).
          </p>
        </section>

        {/* AI Disclaimer Box */}
        <div className="guidance-ai-disclaimer">
          <span className="disclaimer-info-icon" aria-hidden="true">
        ...
        <section className="care-guidance-emergency-section">
          <div className="emergency-section-header">
            <span className="emergency-siren-glyph" aria-hidden="true">
              🚨
            </span>
            <h2 className="emergency-section-title">Emergency</h2>
          </div>
          ...
          >
            <svg
              ...
              aria-hidden="true"
            >
              <polygon points="12 2 22 12 12 22 2 12 12 2" fill="none" />
              <path d="M12 8v4" stroke="currentColor" strokeWidth="2.5" />
